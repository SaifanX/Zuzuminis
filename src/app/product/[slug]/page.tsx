...
export default function ProductPage() {
  ...
  const product = useQuery(api.products.getBySlug, slug ? { slug } : undefined);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="animate-pulse flex flex-col items-center">
          <div className="w-12 h-12 rounded-full border-4 border-zuzu-teal border-t-transparent animate-spin mb-4" />
  ...
  return (
    <main ref={container} className="min-h-screen bg-white selection:bg-zuzu-teal selection:text-white">
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-6 mb-24 relative z-10">
        ...
        <div className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-8 flex gap-2">
           <a href="/" className="hover:text-zuzu-teal transition-colors">Home</a> 
           <span>/</span> 
           <a href="/shop" className="hover:text-zuzu-teal transition-colors">Shop</a> 
           <span>/</span> 
